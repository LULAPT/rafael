// Script aprimorado para fazer a header retrair e expandir ao clicar
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Adicionar novos estilos ao header para a transição e hover
  ...
  style.textContent = `
    ...
    header.minimized:hover {
      transform: scale(1.1);
      box-shadow: 0 0 20px rgba(219, 191, 65, 0) !important;
      border: 1px solid rgba(219, 191, 65, 0) !important;
    }
    ...
    header.minimized:hover .gun-icon {
  ...
  // Função para minimizar o header
  ...
  // Adicionar evento de clique para o header minimizado
